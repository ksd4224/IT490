...
def save_to_txt(data):
    with open(output_file, 'w') as file:
        file.write(json.dumps(data, cls=DateTimeEncoder) + '\n')
    ...
    try:
        ...
        try:
            ...
            if user:
                ...
                # Send success message back to the queue with user meals and workouts
                success_message = {
                    'status': 'success',
                ...
                print(f"User with email {email} not found in the database. Skipping meal and workout fetch.")
