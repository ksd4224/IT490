        ...
        try:
            ...
            if email and post_content:
                ...
                if user:
                    ...
                    # Send success message back to the queue with user_id and all post_content
                    success_message = {
                        'status': 'success',
                ...
                print(f"User with email {email} not found or missing post content. Skipping post addition.")
