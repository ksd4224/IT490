...
if (isset($email)) {
    ...
    echo "email: " . $email . " weight: " . $newWeight;
    try {
...
//read6.php
$queueName = 'front-weight-response';
try {
    // Create a connection to RabbitMQ
        foreach ($rabbitMQHosts as $rabbitMQHost) {
                try {
    ...
    $callback = function ($message) {
        ...
        // Check if the 'status' field is 'success'
               ...
               // header('Content-Type: application/json');
                ...
                header("Location: test.php?weight=success");
                exit();
        } else {
                ...
                header("Location: test.php?weight=no_success");
                exit();
        }
    };
