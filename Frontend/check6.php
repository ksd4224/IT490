...
$exerciseName = $_POST['addToWorkout'];
...
if (isset($email)) {
    ...
    echo "email: " . $email . " exercise: " . $exerciseName;
    try {
...
//read6.php
$queueName = 'front-workout-response';
try {
    // Create a connection to RabbitMQ
        foreach ($rabbitMQHosts as $rabbitMQHost) {
                try {
    ...
    $callback = function ($message) {
        ...
        // Check if the 'status' field is 'success'
               ...
               // header('Content-Type: application/json');
                ...
                header("Location: test.php?workout=success");
                exit();
        } else {
                ...
                header("Location: test.php?workout=no_success");
                exit();
        }
    };
